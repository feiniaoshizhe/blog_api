...
from app.models.value.full_name import FullName
...
class User(SQLAlchemyBaseUserTableUUID, BaseModel):
    ...
    user_name: Mapped[str] = mapped_column(
        "user_name", String(256), nullable=False, comment="用户名"
    )
    real_name: Mapped[FullName] = mapped_column(
        "real_name", JSON, nullable=True, comment="姓名"
    )
